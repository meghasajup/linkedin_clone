        ...
        <Card padding={0}>
            <div className='flex gap-3 p-4'>
                <div className='w-12 h-12 rounded-4xl'>
                    <img src={user} className='rounded-4xl w-12 h-12 border-2 border-white cursor-pointer' />
                </div>
                <div>
            ...
            <div className='my-2 p-4 flex justify-between items-center'>
                <div className='flex gap-1 items-center'>
                    <ThumbUpAltIcon sx={{ color: "blue", fontsize: 12 }} /> <div className='text-sm text-gray-600'>1 Likes</div>
                </div>
                <div className='flex gap-1 items-center'>
            ...
            <div className='flex p-1'>
                <div className='w-[33%] justify-center flex gap-2 items-center border-r-2 border-gray-100 p-2 cursor-pointer hover:bg-gray-100'> <ThumbUpAltIcon sx={{ fontSize: 22, color: "blue" }} /> <span>Like</span> </div>
                <div onClick={()=>setComment(true)} className='w-[33%] justify-center flex gap-2 items-center border-r-2 border-gray-100 p-2 cursor-pointer hover:bg-gray-100'> <CommentIcon sx={{ fontSize: 22 }} /> <span>Comment</span> </div>
                <div className='w-[33%] justify-center flex gap-2 items-center border-r-2 border-gray-100 p-2 cursor-pointer hover:bg-gray-100'> <SendIcon sx={{ fontSize: 22 }} /> <span>Share</span> </div>
            </div>
                ...
                comment && <div className='p-4 w-full'>
                    <div className='flex gap-2 items-center'>
                        ...
                        <form className='w-full flex gap-2' onSubmit={handleSendComment}>
                            <input placeholder='Add a comment...' className='w-full border-2 py-3 px-5 rounded-3xl hover:bg-gray-100' />
